...
var vm = new Vue({
  ...
  mounted: function mounted() {
    var vobj = this; //vobj等於這個vm物件
    //https://blog.csdn.net/joyvonlee/article/details/91868143

    readJSON("../json/front-end.json", function (res) {
...
var vm = new Vue({
  ...
  mounted: function mounted() {
    ...
    readJSON("../json/others.json", function (res) {
      vobj.works = JSON.parse(res);
    });
  }
}); //vue引進資料，APP
...
var vm = new Vue({
  ...
  mounted: function mounted() {
    ...
    readJSON("../json/app.json", function (res) {
      vobj.works = JSON.parse(res);
    });
  }
});
